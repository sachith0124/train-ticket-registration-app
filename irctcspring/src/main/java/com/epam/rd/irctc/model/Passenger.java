...
public class Passenger implements Serializable {
	...
	public Passenger(String passengerName, String dateOfBirth, String gender) {
		super();
	...
	public String toString() {
		return "Passenger [passengerName=" + passengerName + ", dateOfBirth=" + dateOfBirth + ", gender=" + gender
				+ "]";
	}
}
