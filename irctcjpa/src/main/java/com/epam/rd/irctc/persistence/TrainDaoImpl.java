...
public class TrainDaoImpl implements TrainDao {
	...
	public List<Train> getTrains(List<String> trainIdsList) {
		...
		return trainIdsList.isEmpty() ? new ArrayList<Train>() : entityManager.createNamedQuery("getTrainsByTrainIds", Train.class).setParameter("ids", trainIdsList).getResultList();
	}
	...
	public int getSeatFare(String trainId, String seatType) {
		...
		return entityManager.find(Train.class, trainId).getSeatsLog().get(seatType).getSeatFare();
	}
