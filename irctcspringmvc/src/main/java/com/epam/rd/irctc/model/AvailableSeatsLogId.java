...
@Embeddable
public class AvailableSeatsLogId implements Serializable {
	...
	public AvailableSeatsLogId() {
		super();
	}

	public AvailableSeatsLogId(String trainId, String stationId, String date, String seatType) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AvailableSeatsLogId other = (AvailableSeatsLogId) obj;
		if (date == null) {
			if (other.date != null)
				return false;
